...
{   
    ...
    int leaders=0;
    for(int i=0;i<n;i++)leaders+=(DSU.find_set(i)==i);  //this is used to find number of connected components as if i is root node..then it will give 1..else 0..so by this i find root node count..hence number of connected components
